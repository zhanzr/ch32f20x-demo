# CoreMark 1.0 @ 144 MHz — CH32F207VCT6 (f207-evt-r1)
...
Open the USART1 console (`COM18` @ 115200 via the WCH-Link SERIAL). Capture
...
* **SysTick**: the shared board layer (`board/board.c`) defines
  `SysTick_Handler` → 1 ms tick counter; `HAL_GetTick()` is the CORE_TICKS
  timer.
* **ITERATIONS**: 4,000 — at 144 MHz a run takes ~10.5 s, valid (CoreMark
